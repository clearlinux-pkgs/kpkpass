...
Version  : 24.08.0
Release  : 70
URL      : https://download.kde.org/stable/release-service/24.08.0/src/kpkpass-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kpkpass-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kpkpass-24.08.0.tar.xz.sig
...
%setup -q -n kpkpass-24.08.0
cd %{_builddir}/kpkpass-24.08.0
pushd ..
cp -a kpkpass-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724513066
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6PkPass.so.6.2.0
/usr/lib64/libKPim6PkPass.so.6
/usr/lib64/libKPim6PkPass.so.6.2.0
