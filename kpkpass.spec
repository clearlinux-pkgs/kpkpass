...
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/kpkpass-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/kpkpass-20.12.1.tar.xz.sig
...
%prep
%setup -q -n kpkpass-20.12.1
cd %{_builddir}/kpkpass-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610040559
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpkpass-20.12.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kpkpass/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKPimPkPass.so.5.16.1
