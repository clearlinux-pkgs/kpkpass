...
Version  : 20.04.0
Release  : 20
URL      : https://download.kde.org/stable/release-service/20.04.0/src/kpkpass-20.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.04.0/src/kpkpass-20.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.0/src/kpkpass-20.04.0.tar.xz.sig
...
%prep
%setup -q -n kpkpass-20.04.0
cd %{_builddir}/kpkpass-20.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587687855
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpkpass-20.04.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kpkpass/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKPimPkPass.so.5.14.0
