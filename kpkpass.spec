...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kpkpass-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kpkpass-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kpkpass-23.04.0
cd %{_builddir}/kpkpass-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682023831
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim5PkPass.so.5.23.0
